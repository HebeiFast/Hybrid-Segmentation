...
class SemanticSegmentor(nn.Module):
    ...
    def forward(self, batched_inputs):
        ...
        events = [x["event"].to(self.device) for x in batched_inputs]
        events = ImageList.from_tensors(events, self.backbone.size_divisibility)

        features = self.backbone(images.tensor, events.tensor)
