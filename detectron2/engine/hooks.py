...
class ResetSpikingNeuron(HookBase):
...
# class AttnHook(HookBase):
#     """
#     Hook to extract attention weights from a model.
#     """

#     def __init__(self, model, layer_list, train_dataloader, test_dataloader, period=20, max_runs=10):
#         """
#         Args:
#             model (torch.nn.Module): the model to extract attention weights from.
#             layer_list (str): the name of the layer to extract attention weights from.
#             period (int): Output stats each 'period' iterations.
#             max_runs (int): Stop the logging after 'max_runs'.
#         """
...
#         self.train_examples = next(train_dataloader)
...
#             self.trainer.iter == self.trainer.max_iter - 1
#         ):
#             for attn_weight in self._attn_weights:
...
#             self._attn_weights.append(output[1])

#         for _layer_name in self._layer_list:
#             for name, module in self._model.named_modules():
#                 if _layer_name in name:
